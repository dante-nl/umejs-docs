...
If you wish to, you could also automatically change this with for example your `.env` file. For this example, the npm module [dotenv](https://www.npmjs.com/package/dotenv) is used.
